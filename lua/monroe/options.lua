...
vim.opt.incsearch = true                                       -- perform search as items are getting typed in
...
vim.opt.colorcolumn = "120"                                    -- set column highlight
vim.opt.undofile = true                                        -- enable persistent undo
vim.opt.undodir = os.getenv("HOME") .. "/.config/nvim/undodir" -- enable persistent undo
...
vim.g.markdown_fenced_languages = { 'html', 'python', 'vim', 'sql', 'mysql', 'php', 'go', 'godoc', 'bash', 'cs', 'c',
	'cpp', 'cmake', 'valgrind', 'rust', 'git', 'sql', 'mysql', 'zig', 'config', 'confini', 'gdb', 'java', 'javacc',
	'javascript', 'json', 'make', 'nginx', 'nix', 'sed', 'sh', 'sshconfig', 'sshdconfig', 'systemd', 'tar', 'tmux',
	'typescript', 'wget', 'yaml', 'zsh' }
...
vim.cmd([[ autocmd BufEnter *.go :setlocal tabstop=4 ]])
