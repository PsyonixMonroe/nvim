...
local icons = require "monroe.icons"
...
gitsigns.setup {
  signs = {
    ...
    delete = { hl = "GitSignsDelete", text = icons.ui.BoldArrowRight, numhl = "GitSignsDeleteNr", linehl = "GitSignsDeleteLn" },
    topdelete = { hl = "GitSignsDelete", text = icons.ui.BoldArrowRight, numhl = "GitSignsDeleteNr", linehl = "GitSignsDeleteLn" },
